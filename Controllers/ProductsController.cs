        ...
        public IEnumerable<object> GetProduct()
        {
            var products = from pro in _context.Product
                           select new
                           {
                               ...
                               pro.Status,
                               pro.UnitCode,
                               UnitName = _context.Unit.Where(x => x.UnitCode == pro.UnitCode).Select(x => x.UnitName)
                                   .FirstOrDefault(),
                               CatName = _context.CatePro.Where(x => x.CateName == pro.CateName).Select(x => x.NameCate)
                                   .FirstOrDefault()
                           };
            return products;
        }
